                            ...
                            <div class="panel panel-default">
                                ...
                                <form action="{{ route('manual.order') }}" method="post" id="payment-form" enctype="multipart/form-data">
                                    ...
                                    <p style="margin-bottom: 20px; font-size: 14px;">Silahkan lakukan pembayaran transfer
                                      ...
                                      <img src="{{ asset('frontend/assets/images/payments/bca.png') }}" alt="bri"
                                          style="width: 125px;">
                                      <h3 style="float: right; margin-top: 0px;">8955082121 <br><span style="font-size: 14px; font-style: italic;">A.n. Nadia Andika</span></h3>

<footer id="footer" class="footer color-bg">
    <div class="footer-bottom" style="background-color: #ff53a3">
        <div class="container">
            <div class="row">
                @php
    ...
    <div class="copyright-bar"  style="background-color: #e40f73">
        <div class="container"> 
            <div class="col-xs-12 col-sm-12 no-padding social">
                <p class="text-center" style="color: #ffffff"><i class="fa fa-copyright" aria-hidden="true"></i>Shaqila Cake. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
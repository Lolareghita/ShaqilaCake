                ...
                <div class="info-boxes wow fadeInUp">
                    <div class="row">
                        <div class="col-md-6 col-sm-3 col-lg-3">
                            <div class="info-boxes-inner" style="background-color: #e40f73">
                                <div class="info-box">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <i class="fa fa-truck" style="color: #ffffff; font-size: 30px"
                                                aria-hidden="true"></i>
                                            <h4 class="info-box-heading green">BEBAS BIAYA KIRIM</h4>
                                        </div>
                                    </div>
                                    <h6 class="text">Khusus wilayah delta pawan dan sekitarnya untuk pemesanan snack box dan kue tumpeng</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-3 col-lg-3">
                            <div class="info-boxes-inner" style="background-color: #e40f73">
                                <div class="info-box">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <i class="fa fa-star " style="color: #ffffff; font-size: 30px"
                                                aria-hidden="true"></i>
                                            <h4 class="info-box-heading green">Kue Enak Harga terjangkau</h4>
                                        </div>
                                    </div>
                                    <h6 class="text">Tempat Startegis di Pusat Kota</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-3 col-lg-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <i class="fa fa-clock-o" style="color: #ffffff; font-size: 30px"
                                                aria-hidden="true"></i>
                                            <h4 class="info-box-heading green">Buka Senin-Minggu</h4>
                                        </div>
                                    </div>
                                    <h6 class="text">Senin-Jumat : 08.00-21.20 Sabtu : 08.00-21.30 Minggu : 08.00-21.20</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-3 col-lg-3">
                            <div class="info-boxes-inner" style="background-color: #e40f73">
                                <div class="info-box">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <i class="fa fa-map-marker" style="color: #ffffff; font-size: 30px"
                                                aria-hidden="true"></i>
                                            <h4 class="info-box-heading green">Alamat</h4>
                                        </div>
                                    </div>
                                    <h6 class="text">+62-811-5672-600 (admin) JL. Dipanjaitan, Ketapang Kecil, Kalimantan Barat, Indonesia 78852</h6>
                                </div>
                            </div>
                        </div>
                        <!-- .col -->
                ...
                <div class="wide-banners wow fadeInUp outer-bottom-xs">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <img class="img-responsive"
                                        src="{{ asset('frontend/assets/images/banners/baner234.png') }}" alt="">
                                </div>
                            </div>
                            <!-- /.wide-banner -->
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <img class="img-responsive"
                                        src="{{ asset('frontend/assets/images/banners/banerku.png') }}" alt="">
                                </div>
                            </div>
                            <!-- /.wide-banner -->
                        </div>
                ...
                <div class="wide-banners wow fadeInUp outer-bottom-xs" style="margin-top: 30px">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <img class="img-responsive"
                                        src="{{ asset('frontend/assets/images/banners/diskon.png') }}" alt="">
                                </div>
                            </div>
                            <!-- /.wide-banner -->
                        </div>

                                ...
                                <div class="col-6">
                                    <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_weight"
                                                            placeholder="Berat Produk" value="1" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" hidden>
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_code" value="1" placeholder="Barcode"
                                                            class="form-control">
                                                        @error('product_code')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Rasa Produk <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags" class="form-control"
                                                            value="1" data-role="tagsinput" required="">
                                                        @error('product_tags')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>

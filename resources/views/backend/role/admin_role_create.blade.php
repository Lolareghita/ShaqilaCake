                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="name" class="form-control" placeholder="Nama Admin" required> </div>
                                            </div>
                                        </div> <!-- end cold md 6 -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="phone" class="form-control" placeholder="Telepon" required> </div>
                                            </div>
                                        </div> <!-- end cold md 6 -->
                                        <div class="col-md-6">
                                            <div class="form-group">

    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title">Edit Data Admin </h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <img id="showImage" src="{{ (!empty($adminuser->profile_photo_path))? url('upload/admin_images/'.$adminuser->profile_photo_path):url('upload/no_image.jpg') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_16" name="cancel" 
                                                            value="1" {{ $adminuser->cancel == 1 ? 'checked' : '' }}>
                                                        <label for="checkbox_16">Pembatalan</label>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>

...
<head>
    ...
    <link rel="icon" href="{{ asset('backend/images/logo4.png') }}">

    <title>Shaqila Cake Admin - Log in </title>
...
<body class="hold-transition theme-primary" style="background-image: url('{{ asset('backend/images/bg.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">	
            ...
            <div class="col-12">
                <div class="row justify-content-center no-gutters"> 
                    <div class="col-lg-4 col-md-5 col-12">
                        ...
                        <div class="p-50 rounded30 box-shadowed b-2 b-dashed" style="background-color: rgb(252, 128, 169)">
